    ...
    <div class="contentDiv">
      <div class="topDiv">
        <el-row type="flex">
          ...
          <el-col :span="4">
            <el-popover placement="bottom" title="新增预约" width="400" trigger="click">
              <el-form label-width="90px">
                ...
                <el-form-item>
                  <el-button type="success">确定预约</el-button>
                </el-form-item>
              </el-form>
...
export default {
  ...
  computed:{
    getTimePickeOption: function() {
      ...
      if (itemId) {
        var itemStarTime = this.appointmentItem.getValueByID(
          "startTime",
          itemId
        )+"";
        var itemEndTime = this.appointmentItem.getValueByID(
          "closeTime",
          itemId
        )+"";
        var itemStep = this.appointmentItem.getValueByID("taktTime", itemId)+"";
        return {
